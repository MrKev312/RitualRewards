...
public class SunBless : RitualAttachableOutcomeEffectWorker
{
#if V1_3 || V1_4
...
#endif
    {
        ...
        HashSet<string> reducingGC = ["ColdSnap", "IceAge", "LongNight"];
        HashSet<string> endingGC = ["Eclipse"];
        ...
        gameCondition_ForceWeather.def = GameConditionDef.Named("SunBlessing");
